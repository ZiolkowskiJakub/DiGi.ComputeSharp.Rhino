...
**DiGi.ComputeSharp.Rhino** is a C# engineering and architectural software library suite designed for BIM and CAD integrations (such as Revit, RhinoCommon, Grasshopper, and Dynamo BIM).
...
* **[DiGi.ComputeSharp.Geometry.Rhino](DiGi.ComputeSharp.Rhino)** (Path: `DiGi.ComputeSharp.Rhino\DiGi.ComputeSharp.Rhino`)
